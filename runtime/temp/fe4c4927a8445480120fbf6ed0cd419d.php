<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/admin\kami.html";i:1503394777;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/admin\layout.html";i:1503394617;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/common\layout.html";i:1503393726;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/admin\head.html";i:1523866880;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary table-responsive">
                    <div class="panel-heading">
                        <i class="icon-table"></i>卡密生成-剩余余额: <?php echo $userInfo['point']; ?> 元，每张卡密：<?php echo $priceAll; ?> 元
                    </div>
                    <div class="panel-body table-responsive">
						<div class="alert alert-info">
		                    API地址：http://<?php echo $_SERVER['HTTP_HOST']; ?>/<br/>
                    ...
                    <div class="panel-body table-responsive">
                        <table class="table table-bordered table-condensed table-hover table-striped table-vertical-center">
                            ...
                            <tr>
                                ...
                                <td><?php if($km['user']): ?><font color="red">已使用</font><?php else: ?>未使用<?php endif; ?></td>
                                <td><?php echo $km['value']; ?></td>
                                <td><?php echo $km['addtime']; ?></td>
                                <td><?php echo $km['usetime']; ?></td>
                                <td><?php echo $km['user']; ?></td>
