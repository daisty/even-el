<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/admin\weblist.html";i:1503394878;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/admin\layout.html";i:1503394617;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/common\layout.html";i:1503393726;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/admin\head.html";i:1523866880;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                    ...
                    <div class="panel-body">
                        <form method="post">
                            ...
                            <div class="input-group xs-mb-15">
                                <input type="text" placeholder="请输入要搜索的站点名称！" name="s" class="form-control text-center"
                                       required>
                    ...
                    <div class="panel-body table-responsive">
                        <table class="table table-bordered table-condensed table-hover table-striped table-vertical-center">
                            ...
                            <tr>
                                ...
                                <th>站点名称</th>
                                <th>剩余金额</th>
                                <th style="width: 150px; text-align: center">充值</th>
                                <th>站长QQ</th>
                                <th>UPID</th>
                                <th>UID</th>
                                <th>开通时间</th>
                            ...
                            <tbody>
                            <?php if(is_array($webList) || $webList instanceof \think\Collection): $i = 0; $__LIST__ = $webList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$web): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td><?php if($web['super'] != 0): ?><font color="red"><?php endif; ?><?php echo $web['zid']; ?></font></td>
                                <td><?php echo $web['name']; ?></td>
                                <td><?php echo $web['point']; ?></td>
                                    ...
                                    <form class="form-inline" method="post" novalidate="">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" name="uid" value="<?php echo $web['uid']; ?>">
                                                <input type="text" name="point" class="form-control" value="10"
                                                       style="width: 80px;">
                                ...
                                <td><?php echo $web['qq']; ?></td>
                                <td><?php echo $web['upzid']; ?></td>
                                <td><?php echo $web['uid']; ?></td>
                                <td><?php echo $web['addtime']; ?></td>
                                <td><?php echo $web['domain']; ?></td>
                                <td><?php echo $web['domain2']; ?></td>
                                <td><?php echo $web['endtime']; ?></td>
                                <td>
                                    <a href="?action=del&zid=<?php echo $web['zid']; ?>" class="btn-xs btn-warning"
                                       onclick="return confirm('确认删除？');">删除</a>
                                    <a href="<?php echo url('webSet',['zid'=>$web['zid']]); ?>" class="btn-xs btn-info">修改</a>
                                </td>
                            </tr>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <tr class="text-center">
                                <td colspan="12"><?php echo $pageList->showPage(); ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
