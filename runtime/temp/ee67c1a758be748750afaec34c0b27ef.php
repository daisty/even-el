<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"D:\phpStudy\WWW/application/index/view3/admin\kmlist.html";i:1524218565;s:57:"D:\phpStudy\WWW/application/index/view3/admin\layout.html";i:1503394617;s:58:"D:\phpStudy\WWW/application/index/view3/common\layout.html";i:1523935237;s:55:"D:\phpStudy\WWW/application/index/view3/admin\head.html";i:1524219193;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        用户余额: <?php echo $userInfo['point']; ?> 元
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal group-border-dashed" method="post">
                            <input type="hidden" name="action" value="add">
                            <div class="form-group">
                                <label class="col-sm-1 control-label">用户金额：</label>
                                <div class="col-sm-4">
                                    <input name="value" type="number" min="1" max="1000"
                                           placeholder="输入金额！（最低1元，最高1000元每张卡）" class="form-control"
                                           required>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <button type="submit" class="btn btn-space btn-success">确认查询</button>&nbsp;
