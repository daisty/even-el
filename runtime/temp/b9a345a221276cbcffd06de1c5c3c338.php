<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"D:\phpStudy\WWW/application/index/view3/panel\profile.html";i:1503394228;s:57:"D:\phpStudy\WWW/application/index/view3/panel\layout.html";i:1503393754;s:58:"D:\phpStudy\WWW/application/index/view3/common\layout.html";i:1523935237;s:55:"D:\phpStudy\WWW/application/index/view3/panel\head.html";i:1524216478;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label">配额</label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" value="<?php echo $userInfo['peie']; ?>元" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="pwd" class="form-control" placeholder="不修改则留空">
                                </div>
                            </div>
							<?php if($userInfo['power'] == 9): ?>
							<div class="form-group">
                                <label class="col-lg-3 control-label">提现支付宝账号</label>
                                <div class="col-lg-8">
                                    <input type="text" name="pay_account" class="form-control" value="<?php echo $userInfo['pay_account']; ?>">
									<pre>如果填错将无法结算到账！</pre>
                                </div>
                            </div>
							<div class="form-group">
                                <label class="col-lg-3 control-label">提现支付宝姓名</label>
                                <div class="col-lg-8">
                                    <input type="text" name="pay_name" class="form-control" value="<?php echo $userInfo['pay_name']; ?>">
                                </div>
                            </div>
							<?php endif; ?>
