<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/panel\shop.html";i:1524028423;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/panel\layout.html";i:1503393754;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/common\layout.html";i:1523935237;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/panel\head.html";i:1524028465;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
					...
					<table class="table table-hover table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo $row['price_all']; ?>元/<?php echo $row['price_dx']; ?>元</td>
								<td>
									<b><?php echo $row['price_vip']; ?></b>元</td>
								<td>
									<a href="<?php echo url('shop'); ?>?action=buy&id=<?php echo $row['id']; ?>">购买</td>
							</tr>
					...
					<div class="container-fluid">
					 <!-- 列排序  把2个列的位置顺序交换，宽度不变 , col-md-push-3: 向右移动3列, col-md-pull-9: 向左移动9列 -->
							<div class="row bg-primary"> 
									<div class="col-md-6 col-md-push "><input class="check" type="checkbox">请选择栏编号</div>
