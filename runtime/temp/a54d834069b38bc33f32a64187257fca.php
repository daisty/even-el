<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/panel\rank.html";i:1503394274;s:69:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/panel\layout.html";i:1503393754;s:70:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/common\layout.html";i:1523935237;s:67:"C:\phpStudy\PHPTutorial\WWW/application/index/view3/panel\head.html";i:1524028465;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                        ...
                        <ul class="nav nav-second-level collapse">
                            <li>
                                <a href="<?php echo url('shop'); ?>">
                                    ...
                                    <span class="submenu-label">自助购买套餐</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo url('recharge'); ?>">
...
<div class="wrapper">
    ...
    <div class="main-header clearfix">
        <div class="page-title">
            <h3 class="no-margin"><?php echo $webTitle; ?></h3>
        </div><!-- /page-title -->
    </div>
                ...
                <div class="panel panel-primary table-responsive">
                    ...
                    <div class="panel-body table-responsive">
                        <table class="table table-bordered table-condensed table-hover table-striped table-vertical-center">
                            ...
                            <tbody>
                            <?php if(is_array($rankList) || $rankList instanceof \think\Collection): $i = 0; $__LIST__ = $rankList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;if($rank['count'] > 0): ?>
                            <tr>
                                <td><span class="badge badge-danger bounceIn animation-delay2 m-left-xs"><?php echo $i; ?></span></td>
                                <td class="text-center"><?php echo $rank['zid']; ?></td>
                                <td class="text-center"><?php echo $rank['name']; ?></td>
                                <td class="text-center"><?php echo $rank['count']; ?></td>
                            </tr>
                            ...
                            <tr>
                                <td><span class="badge badge-danger bounceIn animation-delay2 m-left-xs"><?php echo $i; ?></span></td>
                                <td class="text-center"><?php echo $rank['uid']; ?></td>
                                <td class="text-center"><?php echo $rank['user']; ?></td>
                                <td class="text-center"><?php echo $rank['count']; ?></td>
                            </tr>
