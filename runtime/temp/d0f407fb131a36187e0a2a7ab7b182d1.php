            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <div class="list-group-item list-group-item-success text-center">每日前<?php echo $num; ?>名签到的人至少可以获得<?php echo $rule[1]; ?>元奖励！</div>
                        <div class="list-group-item list-group-item-info">
                            <div class="progress">
                                <div class="progress-bar progress-bar-warning" style="width: <?php echo $day * 10; ?>%;"></div>
                            </div>
                            <div class="text-center">我已连续签到 <strong><?php echo $day; ?></strong>天！</div>
                        </div>
