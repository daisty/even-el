...
var ptui_daid=encodeURIComponent("5")//业务隔离id
    ...
    ,ptui_pt_version=encodeURIComponent("10226")
    ,ptui_version=encodeURIComponent("201203081004")
    ,ptui_style=encodeURIComponent("9")
    ,ptui_noAuth="1"//是否需要去检查业务隔离，默认为1，需要检查（数字）
    ,g_href="https\x3A\x2F\x2Fui.ptlogin2.qq.com\x2Fcgi-bin\x2Flogin\x3Fpt_hide_ad\x3D1\x26style\x3D9\x26pt_ttype\x3D1\x26appid\x3D549000929\x26pt_no_auth\x3D1\x26pt_wxtest\x3D1\x26daid\x3D5\x26s_url\x3Dhttps\x253A\x252F\x252Fh5.qzone.qq.com\x252Fmqzone\x252Findex"
    ,ptui_pt_qzone_sig="0"
...
function loadJs(){
	...
	loadJs.hasLoad=true;
	/*===grunt bottom_inc===*/
	var jsPath="login_10.js";
	loadScript(jsPath,function(){
		//海伦娜 js拉取失败,重试一次
		var serverJsPath="login_10.js";
