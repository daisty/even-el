...
function weixin_sig_cb() {
	...
	"object" == typeof WeixinJSBridge && "function" == typeof WeixinJSBridge.invoke ? t() : document.addEventListener ? document.addEventListener("WeixinJSBridgeReady", t, !1) : document.attachEvent && (document.attachEvent("WeixinJSBridgeReady", t), document.attachEvent("onWeixinJSBridgeReady", t))
}
function ptui_checkVC(t, e, n, i, o) {
	pt.isloading && (clearTimeout(pt._timer), pt.endLoading(), pt.cb_checkVC(t, e, n, i, o))
}
...
function doOpenApp(t, e) {
	var n = $.detectBrowser(),
		...
		o = {};
	if (pt.isWX && !e) WeixinJSBridge.invoke("launchApplication", {
		schemeUrl: t
	}, function(e) {
		...
		switch (i && (o = {
			...
			meizu: "mzbrowser",
			liebaofast: "lb"
		}, o[i] && (t += "&schemacallback=" + encodeURIComponent(o[i] + "://"))), r) {
		case "iframe":
		...
		ucbrowser: "ucbrowser://",
		liebao: "lb://u/100/"
	}, o[i] && (t += "&schemacallback=" + encodeURIComponent(o[i]))), pt.isInIframe ? top.location.href = t : location.href = t, openApp.flag = "location"
}
...
function ptui_wtlogin_CB() {
	clearInterval(pt.qrcode.clock), pt.isLoading && pt.endLoading(), window.wtCB && window.wtCB.apply(window, arguments)
}
...
$.cookie = {
	...
	ajax: function(url, para, cb, method, type) {
		...
		return xhr.open(method, url), xhr.onreadystatechange = function() {
			4 == xhr.readyState && ((xhr.status >= 200 && xhr.status < 300 || 304 === xhr.status || 1223 === xhr.status || 0 === xhr.status) && cb(void 0 === type && xhr.responseText ? eval("(" + xhr.responseText + ")") : xhr.responseText), xhr = null)
		}, xhr.send(para), xhr
	},
	...
	return {
		...
		time33: function(t) {
			for (var e = 0, n = 0, i = t.length; n < i; n++) e = 33 * e + t.charCodeAt(n);
			return e % 4294967296
		},
		hash33: function(t) {
	...
	needVip: function(t) {
		for (var e = ["21001601", "21000110", "21000121", "46000101", "716027609", "716027610", "549000912", "717016513"], n = !0, i = 0, o = e.length; i < o; i++) if (e[i] == t) {
			n = !1;
			break
		}
		return n
	...
	nlog: function(t, e, n) {
		...
		e = e || 0, n && (i += "u=" + n + "&"), i += "id=" + e + "&msg=" + o + "&v=" + Math.random(), $.http.preload(i)
	},
	log: function(t) {
	...
	Math.random() < .01 && (void 0 !== window.postMessage ? t += "&2=2000" : t += "&2=1000", t += "&v=" + Math.random(), $.http.preload(t))
	...
	function _(t) {
		...
		if (a-- > 0) for (p < this.DB && (n = this[a] >> p) > 0 && (o = !0, r = l(n)); a >= 0;) p < e ? (n = (this[a] & (1 << p) - 1) << e - p, n |= this[--a] >> (p += this.DB - e)) : (n = this[a] >> (p -= e) & i, p <= 0 && (p += this.DB, --a)), n > 0 && (o = !0), o && (r += l(n));
		return o ? r : "0"
	}
	function v() {
		var t = p();
	...
	function A(t, e) {
		for (var n = 0, i = 0, o = Math.min(t.t, this.t); n < o;) i += this[n] - t[n], e[n++] = i & this.DM, i >>= this.DB;
		if (t.t < this.t) {
	...
	function D(t, e, n) {
		...
		if (!(i.t <= 0)) {
			...
			if (0 != d) {
				...
				null != e && (n.drShiftTo(l, e), s != c && a.ZERO.subTo(e, e)), n.t = l, n.clamp(), u > 0 && n.rShiftTo(u, n), s < 0 && a.ZERO.subTo(n, n)
			}
		}
	}
	function L(t) {
	...
	function z(t, e) {
		var n;
		return n = t < 256 || e.isEven() ? new M(e) : new U(e), this.exp(t, n)
	}
	function J(t) {
		lt[dt++] ^= 255 & t, lt[dt++] ^= t >> 8 & 255, lt[dt++] ^= t >> 16 & 255, lt[dt++] ^= t >> 24 & 255, dt >= gt && (dt -= gt)
	}
	function W() {
		J((new Date).getTime())
	}
	...
	var rt;
	"Microsoft Internet Explorer" == navigator.appName ? (a.prototype.am = c, rt = 30) : "Netscape" != navigator.appName ? (a.prototype.am = s, rt = 26) : (a.prototype.am = u, rt = 28), a.prototype.DB = rt, a.prototype.DM = (1 << rt) - 1, a.prototype.DV = 1 << rt;
	...
	for (at = "A".charCodeAt(0), pt = 10; pt < 36; ++pt) ct[at++] = pt;
	M.prototype.convert = x, M.prototype.revert = B, M.prototype.reduce = O, M.prototype.mulTo = R, M.prototype.sqrTo = H, U.prototype.convert = N, U.prototype.revert = P, U.prototype.reduce = j, U.prototype.mulTo = V, U.prototype.sqrTo = Q, a.prototype.copyTo = f, a.prototype.fromInt = h, a.prototype.fromString = w, a.prototype.clamp = m, a.prototype.dlShiftTo = q, a.prototype.drShiftTo = S, a.prototype.lShiftTo = T, a.prototype.rShiftTo = I, a.prototype.subTo = A, a.prototype.multiplyTo = E, a.prototype.squareTo = C, a.prototype.divRemTo = D, a.prototype.invDigit = K, a.prototype.isEven = F, a.prototype.exp = G, a.prototype.toString = _, a.prototype.negate = v, a.prototype.abs = y, a.prototype.compareTo = b, a.prototype.bitLength = $, a.prototype.mod = L, a.prototype.modPowInt = z, a.ZERO = g(0), a.ONE = g(1);
	var ut, lt, dt;
	if (null == lt) {
		lt = new Array, dt = 0;
		var ft;
		if ("Netscape" == navigator.appName && navigator.appVersion < "5" && window.crypto && window.crypto.random) {
			...
			for (ft = 0; ft < ht.length; ++ft) lt[dt++] = 255 & ht.charCodeAt(ft)
		}
		for (; dt < gt;) ft = Math.floor(65536 * Math.random()), lt[dt++] = ft >>> 8, lt[dt++] = 255 & ft;
		dt = 0, W()
	}
	Y.prototype.nextBytes = Z, tt.prototype.init = et, tt.prototype.next = nt;
	var gt = 256;
	return {
		rsa_encrypt: ot
	}
	...
	function n(t, e, n) {
		(!n || n > 4) && (n = 4);
		for (var i = 0, o = e; o < e + n; o++) i <<= 8, i |= t[o];
	...
	function p(t) {
		var e, n, i = [],
			o = t.length;
		for (e = 0; e < o; e++) n = t.charCodeAt(e), n > 0 && n <= 127 ? i.push(t.charAt(e)) : n >= 128 && n <= 2047 ? i.push(String.fromCharCode(192 | n >> 6 & 31), String.fromCharCode(128 | 63 & n)) : n >= 2048 && n <= 65535 && i.push(String.fromCharCode(224 | n >> 12 & 15), String.fromCharCode(128 | n >> 6 & 63), String.fromCharCode(128 | 63 & n));
		return i.join("")
	}
	function s(t) {
		m = new Array(8), _ = new Array(8), v = y = 0, $ = !0, w = 0;
		var n = t.length,
			i = 0;
		w = (n + 10) % 8, 0 != w && (w = 8 - w), b = new Array(n + w + 10), m[0] = 255 & (248 & e() | w);
		for (var o = 1; o <= w; o++) m[o] = 255 & e();
		w++;
		for (var o = 0; o < 8; o++) _[o] = 0;
		for (i = 1; i <= 2;) w < 8 && (m[w++] = 255 & e(), i++), 8 == w && u();
		for (var o = 0; n > 0;) w < 8 && (m[w++] = t[o++], n--), 8 == w && u();
		for (i = 1; i <= 7;) w < 8 && (m[w++] = 0, i++), 8 == w && u();
		return b
	}
	function c(t) {
		var e = 0,
	...
	function u() {
		...
		for (var e = l(m), t = 0; t < 8; t++) b[v + t] = e[t] ^ _[t], _[t] = m[t];
		y = v, v += 8, w = 0, $ = !1
	}
	function l(t) {
		for (var e = 16, o = n(t, 0, 4), r = n(t, 4, 4), a = n(g, 0, 4), p = n(g, 4, 4), s = n(g, 8, 4), c = n(g, 12, 4), u = 0; e-- > 0;) u += 2654435769, u = (4294967295 & u) >>> 0, o += (r << 4) + a ^ r + u ^ (r >>> 5) + p, o = (4294967295 & o) >>> 0, r += (o << 4) + s ^ o + u ^ (o >>> 5) + c, r = (4294967295 & r) >>> 0;
		var l = new Array(8);
		return i(l, 0, o), i(l, 4, r), l
	}
	function d(t) {
		for (var e = 16, o = n(t, 0, 4), r = n(t, 4, 4), a = n(g, 0, 4), p = n(g, 4, 4), s = n(g, 8, 4), c = n(g, 12, 4), u = 3816266640; e-- > 0;) r -= (o << 4) + s ^ o + u ^ (o >>> 5) + c, r = (4294967295 & r) >>> 0, o -= (r << 4) + a ^ r + u ^ (r >>> 5) + p, o = (4294967295 & o) >>> 0, u -= 2654435769, u = (4294967295 & u) >>> 0;
		var l = new Array(8);
		return i(l, 0, o), i(l, 4, r), l
	}
	function f() {
		for (var t = (k.length, 0); t < 8; t++) _[t] ^= k[v + t];
		return _ = d(_), v += 8, w = 0, !0
	}
	function h(t, e) {
		var n = [];
	...
	q.PADCHAR = "=", q.ALPHA = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", q.getbyte = function(t, e) {
		...
		for (e = 0; e < p; e += 3) n = r(t, e) << 16 | r(t, e + 1) << 8 | r(t, e + 2), a.push(o.charAt(n >> 18)), a.push(o.charAt(n >> 12 & 63)), a.push(o.charAt(n >> 6 & 63)), a.push(o.charAt(63 & n));
		switch (t.length - p) {
		case 1:
	...
	function h(e, n, i, o) {
		...
		return setTimeout(function() {
			f(488358, 1)
		}, 0), btoa(d(h)).replace(/[\/\+=]/g, function(t) {
			return {
				"/": "-",
				"+": "*",
				"=": "_"
...
try {
	window.MTT = function() {
		function t() {
			try {
				if (!o) return !1;
				if (/msie/i.test(navigator.userAgent) && "notify" in window.external) return !0;
				var t = p && o >= 42,
					e = s && o >= 32,
					n = a && o >= 42;
				return t || e || n
		...
		function e(t) {
			...
			"function" == typeof t && (e ? /msie/i.test(window.navigator.userAgent) ? window.external.notify("#@getUserInfoWT@#pt.qqBrowserCallback") : a ? browser.login.getLoginInfo ? browser.login.getLoginInfo(t, t) : t("") : (p || s) && (browser.login.getUinAndSidInfo ? browser.login.getUinAndSidInfo(t, t) : t("")) : (t(""), 5 == $.cookie.get("pt_qlogincode") && $.report.nlog("快速登录异常：pt_qlogincode=5", "276650")))
		}
		function n(t, e) {
			if (!o) return e && e(), !1;
			if (a) {
			...
			} else(p || s) && window.x5 && x5.exec(function(n) {
	...
	$.report.nlog("QB Exception:ver(" + window.ptui_pt_version + ")" + t.message, "647127"), window.MTT = {}
}
var pt = {
	pageState: 1,
	login_href: g_href,
	...
	init: function() {
		pt.hasInit || (pt.hasInit = !0, pt.default_face_url = "//imgcache.qq.com/ptlogin/v4/style/0/images/1.gif", pt.initSURL(), pt.setClickEvent(), pt.isOffice && pt.open.loadAppInfo(), pt.qqBrowserQlogin(), pt.auth(), pt.bindEvent(), pt.bindInput(), pt.hideURLBar(), pt.setVcodeFlag(), pt.setUrl(), pt.showAutoLogin(), $.winName.set("login_href", encodeURIComponent(pt.login_href)), pt.checkIframe(), pt.checkPostMessage(), 42 == window.ptui_style && pt.uInput && pt.uInput.focus(), window.setTimeout(function(t) {
		...
		}, 2e3), $.http.loadScript("TCapIframeApi.js?aid=" + window.ptui_appid + "&rand=" + Math.random() + "&clientype=1&lang=" + pt.lang_num + "&apptype=2", function() {}))
	},
	...
	setUrl: function() {
		...
		pt.checkUrl = e + "ptlogin2." + pt.domain + "/check?", pt.loginUrl = t + "ptlogin2." + pt.domain + "/"
	},
	...
	webLoginReport: function() {
		try {
			...
			if (n) {
				for (var i = n[t[0]], o = 1, r = t.length; o < r; o++) n[t[o]] && (e[o] = n[t[o]] - i);
	...
	showAlert: function(t) {
		pt.alertBackground || (pt.alertBackground = document.createElement("div"), pt.alertBackground.className = "qui-dialog-mask"), pt.alertDiv || (pt.alertDiv = document.createElement("div"), pt.alertDiv.className = "qui-dialog-box"), pt.alertDiv.innerHTML = '<div class="qui-dialog-content">' + t + '</div><div class="qui-dialog-bottom" onclick="pt.hideAlert()">' + STR_LANG.close + "</div>", document.body.appendChild(pt.alertBackground), document.body.appendChild(pt.alertDiv)
	},
	hideAlert: function() {
		document.body.removeChild(pt.alertBackground), document.body.removeChild(pt.alertDiv)
	},
	is_oversea: !1,
	enterOverseaLogin: function() {
		...
		var t = $("oversea");
		t && $.css.show(t), pt.is_oversea = !0, $("state").value = _areaList[0].n, $("country-code").innerHTML = "+" + _areaList[0].c, window.openSDK && window.openSDK.clearAllEdit && ($("password").value = "", window.openSDK.clearAllEdit())
	},
	exitOverseaLogin: function() {
		var t = $("oversea");
		t && $.css.hide(t), pt.is_oversea = !1, window.openSDK && window.openSDK.clearAllEdit && (pt.pInput.value = "", window.openSDK.clearAllEdit())
	},
	...
	setOverseaCountry: function(t) {
		for (var e in _areaList) if (t == _areaList[e].n) return $("state").value = _areaList[e].n, $("country-code").innerHTML = "+" + _areaList[e].c, void pt.exitOverseaCountry()
	},
	initOverseaCountry: function() {
		var t = $("country-search"),
			e = $("country-list"),
			n = "";
		if (t.value = "", _areaList) for (var i in _areaList) n += "<li onclick=\"pt.setOverseaCountry('" + _areaList[i].n + "')\">" + _areaList[i].n + "</li>";
		e.innerHTML = n
	},
	updateOverseaCountry: function() {
		...
		if (_areaList) {
			...
			for (var o in _areaList)(i.test(_areaList[o].c) || i.test(_areaList[o].n) || i.test(_areaList[o].p)) && (n += "<li onclick=\"pt.setOverseaCountry('" + _areaList[o].n + "')\">" + _areaList[o].n + "</li>")
		}
		e.innerHTML = n
	},
	...
	checkPostMessage: function() {
		void 0 === window.postMessage && $.report.nlog("iphone登录框不支持postMessage;", "350525"), void 0 === window.JSON && $.report.nlog("iphone登录框不支持JSON;", "362678")
	},
	...
	auth: function() {
		...
		var t = pt.getAuthUrl(),
			...
			n = $.str.hash33(e);
		!parseInt($.cookie.get("supertoken")) && n && $.cookie.set("supertoken", $.str.hash33(e), "ptlogin2." + pt.domain), window.ptui_daid && "1" != window.ptui_noAuth && "" != e && !pt.isWtlogin && $.http.loadScript(t)
	},
	showAuth: function(t) {
	...
	qqBrowserCallback: function(t) {
		try {
			t && "string" == typeof t && (t = JSON.parse(t)), t && $.check.isQQ(t.uin) && 0 != t.loginkey.length && t.loginkey.length > 10 ? (pt.qqBrowserInfo = {}, pt.qqBrowserInfo.uin = $.str.encodeHtml(t.uin), pt.qqBrowserInfo.nick = $.str.encodeHtml(t.nickname), pt.qqBrowserInfo.loginkey = t.loginkey, pt.qqBrowserInfo.type = 2, pt.refreshQloginUI()) : t && 0 == t.uin.length ? $.report.nlog("快速登录异常：数据返回异常,没有uin", "276650") : t && 0 == t.loginkey.length ? $.report.nlog("快速登录异常：数据返回异常,没有loginkey", "276650") : t && $.report.nlog("快速登录异常：数据返回异常:" + t.loginkey.length, "276650")
		} catch (t) {
	...
	addParamToUrl: function(t, e, n) {
		var i = t.split("#"),
			o = i[0].indexOf("?") > 0 ? "&" : "?";
		return "?" == i[0].substr(i[0].length - 1, 1) && (o = ""), i[1] ? i[1] = "#" + i[1] : i[1] = "", i[0] + o + e + "=" + n + i[1]
	},
	getParam: function() {
	...
	build_qlogin_list: function() {
		...
		var e = t.length;
		if (35 == window.ptui_style && e > 1 && (e = t.length = 1), e > 0 && !window.ptui_tab) {
			pt._switch(2), pt.hideOneKey();
			for (var n = "", i = 0; i < e; i++)"" != t[i].uin && (n += pt.regTmp.replace(/#uin#/g, t[i].uin).replace(/#nick#/g, t[i].nick).replace(/#pwd#/g, t[i].pwd).replace(/#type#/g, t[i].type).replace(/#src#/g, pt.default_face_url));
			e > 1 && xMsg && xMsg.call && xMsg.call("connect", "userSwitch", {}, function() {}), $("q_logon_list").innerHTML = n;
			for (var i = 0; i < e; i++) pt.getShortWord($("nick_" + t[i].uin), t[i].nick, 95);
			pt.initFace(), $("swicth_login") && ($("swicth_login").style.display = "block")
	...
	build_office_qlogin: function() {
		if ($.report.monitor(2123219), pt.cookieInfo || pt.setCookieLogin(), !pt.cookieInfo) return $.report.monitor(2123220);
		pt.cookieLogin = !0, $("hl_avatar").style.backgroundImage = "url(https://q4.qlogo.cn/g?b=qq&nk=" + pt.cookieInfo.uin + "&s=100)", $("hl_usernick").innerHTML = pt.cookieInfo.nick || pt.cookieInfo.uin, $("hl_qqnum").innerHTML = "(" + pt.cookieInfo.uin + ")", pt.fill_usernick()
	},
		...
		if (i > 0) {
			...
			setTimeout(function() {
				...
				window.ptui_lockuin ? e && $.css.hide(e) : e && $.e.add(e, "click", function(t) {
					pt.showOneKey.ever && pt.showOneKey(), pt.qqBrowserInfo = null, pt.open.authListDone && !window.ptui_tab && (xMsg.call("connect", "userSwitch", {}, function() {}), pt.cancel_cookielogin(!0), $.report.monitor(2106346))
				})
			}, 0)
		}
	},
	_switch: function(t) {
		var e = function() {
				var t = $("swicth_login");
				$("q_login").style.display = "block", $("web_login").style.display = "none", t && (t.innerHTML = $.str.encodeHtml("切换帐号"), t.classList.add("weakest")), pt.hideURLBar(), pt.pageState = 2
			},
			n = function() {
				var t = $("swicth_login");
				pt.showOneKey.ever && pt.showOneKey(), $("q_login").style.display = "none", $("web_login").style.display = "block", t && (t.innerHTML = $.str.encodeHtml(login_wording), t.classList.remove("weakest")), pt.uInput.focus(), pt.pageState = 1, window.xMsg && xMsg.call("connect", "userSwitch", {}, function() {})
			};
		if (void 0 === t)"none" == $("q_login").style.display ? e() : n();
		else switch (+t) {
		case 2:
			e();
			break;
		...
		pt.showAutoLogin(), pt.isInIframe && window.setTimeout(function() {
			pt.ptui_notifySize("content")
		}, 0)
	},
	checkNetwork: function() {
		if (navigator.onLine) return pt._timer = setTimeout(function() {
	...
	startLoading: function() {
		pt.loadingDiv || (pt.loadingDiv = document.createElement("div"), pt.loadingDiv.className = "qui-loading-mask"), document.body.appendChild(pt.loadingDiv), pt.isloading = !0
	},
	endLoading: function() {
		document.body.removeChild(pt.loadingDiv), pt.isloading = !1
	},
	submitEvent: function(t) {
		pt.checkNetwork(), pt.startLoading(), pt.isOffice && pt.cookieLogin ? pt.cookielogin_submit() : pt.isOffice && pt.qqBrowserInfo ? pt.qlogin_submit() : window.openSDK && openSDK.getMD5FromNative ? openSDK.getMD5FromNative(function() {
			pt.check(!1)
		}) : pt.check(!1), pt.qrcode.used = !1
	},
	showOneKey: function(t) {
		...
		if (pt.showOneKey.ever || ($.e.add(e, pt.clickEvent, pt.doOneKey), $.e.add(e, "blur", pt.cancelAutoOneKey)), pt.showOneKey.ever = !0, t ? pt.btnGo.className += " weak" : e.className += " weak", e && $.css.show(e), e.focus(), $.report.monitor(414089), pt.isInIframe && window.setTimeout(function() {
			...
			e.innerHTML = o.replace("{{second}}", i--), pt.showOneKey.tid = setInterval(function() {
				e.innerHTML = o.replace("{{second}}", i--), i < 0 && (i = 3, clearInterval(pt.showOneKey.tid), e.innerHTML = n, pt.doOneKey())
			}, 1e3)
		}
	},
	...
	hideOneKey: function() {
		pt.cancelAutoOneKey(), pt.showOneKey.ever = !1, pt.isWtlogin || 35 == window.ptui_style || (pt.btnGo.className = pt.btnGo.className.replace("weak", "")), pt.btnOnekey && $.css.hide(pt.btnOnekey), pt.isInIframe && window.setTimeout(function() {
			pt.ptui_notifySize("content")
		}, 0)
	},
	bindEvent: function() {
		var t = pt.uInput,
			e = pt.pInput;
		$.e.add(pt.btnGo, pt.clickEvent, pt.submitEvent), pt.btnGo2 && $.e.add(pt.btnGo2, pt.clickEvent, function() {
			for (var t = $("q_logon_list"), e = 0; e < t.children.length; ++e) if (t.children[e].onclick) return void pt.clickHeader({
				preventDefault: function() {},
				currentTarget: t.children[e]
			}, !0)
		}), e && $.e.add(e, "keydown", function(t) {
			13 == t.keyCode && pt.submitEvent()
		}), t && $.e.add(t, "keydown", function(t) {
			13 == t.keyCode && (pt.checkNetwork(), pt.startLoading(), pt.check(!1))
		});
		...
		if ($("show_pwd") && $.e.add($("show_pwd"), "change", function(t) {
			...
			"1033" != pt.lang_num && (n += "&account=" + e), window.open(n)
			...
			$.e.add(a, "change", function() {
				a.checked ? pt.s_url = pt.addParamToUrl(pt.s_url, "ss", 1) : pt.s_url = pt.s_url.replace(/&?ss=1/, ""), pt.low_login_enable = a.checked ? 1 : 0
			})
		}
		if ($("download-link") && $("download-area")) {
			$.e.add($("download-area"), "click", function(t) {
				return t.target !== $("download-link") && $("download-link").click(), !1
			});
			var p = [
		...
		$("qrlogin_switch") && $.e.add($("qrlogin_switch"), "click", function() {
			return pt.switchpwd(), !1
		}), $("qr_invalid") && $.e.add($("qr_invalid"), "click", function() {
			pt.qrcode.get(0), $.css.hide($("qr_invalid"))
		...
		}, !0), $("switcher_qlogin") && $.e.add($("switcher_qlogin"), "click", function() {
			return pt.switchqr(), !1
		}), setTimeout(function() {
	...
	bindInput: function() {
		if (!pt.isOffice) {
			var t = window.ptui_defuin || pt.lockedAccount || pt.getLastUin(),
				...
				c = function(t, e, n, i) {
					return function(o) {
						e ? t && $.css.show(t) : t && $.css.hide(t), i && n && (n.style.paddingRight = e ? "20px" : "")
					}
				},
			...
			t && (e.value = "0" == t ? "" : e.value || t), pt.lockedAccount && (e.readOnly = !0, n.focus());
			var _ = function(t, e, n) {
					return function(i) {
						if (!pt.lockedAccount || n) {
							var o = i.target;
							if ("" != i.target.value ? t() : e(), n) {
								var r = 0;
								(o.selectionStart || "0" == o.selectionStart) && (r = Math.max(o.selectionStart, o.selectionEnd)), window.openSDK && window.openSDK.curPosFromJS && window.openSDK.curPosFromJS(r)
							}
						}
					}
				},
				v = function(t, e) {
					return function(n) {
						"" != n.target.value && t(), e && window.openSDK && window.openSDK.isPasswordEdit && window.openSDK.isPasswordEdit(1)
					}
				},
				y = function(t, e, n) {
					return function(i) {
						"" == i.target.value && t(), e ? window.openSDK && window.openSDK.isPasswordEdit && window.openSDK.isPasswordEdit(0) : (/^\+/.test(i.target.value) && (i.target.value = i.target.value.replace(/^\+/, ""), /^00/.test(i.target.value) || (i.target.value = "00" + i.target.value)), "" == i.target.value ? t() : n && pt.checkQQUin(i.target.value))
					}
				};
			$.e.add(n, "focus", v(d, !0)), $.e.add(n, "blur", y(f, !0)), $.e.add(n, "input", function(t) {
				window.setTimeout(function() {
					_(d, f, !0)(t)
				}, 0)
			}), $.e.add(e, "focus", v(u)), $.e.add(e, "blur", y(l, !1, !0)), $.e.add(e, "input", _(u, l));
			var b = function(t, e, n) {
					return function(i) {
						i && i.preventDefault(), t.value = "", n && window.openSDK && window.openSDK.clearAllEdit && window.openSDK.clearAllEdit(), t.focus(), e()
					}
				};
			i && $.e.add(i, "click", b(e, l)), o && $.e.add(o, "click", b(n, f, !0))
		}
	},
	...
	doOneKey: function(t) {
		if (!pt.doOneKey.ing) {
			...
			"1" == window.ptui_pt_ttype && (n += "&pt_ttype=1"), window.ptui_daid && (n += "&daid=" + ptui_daid), pt.low_login_enable && (n += "&low_login_enable=1&low_login_hour=" + window.ptui_low_login_hour), n += "&style=" + window.ptui_style;
			var i = $.detectBrowser()[0];
			i && (n += "&pt_ua=" + $.Encryption.md5(e), n += "&pt_browser=" + i);
			var o = $.bom.query("pt_appname");
			o && (n += "&pt_appname=" + o);
			var r = $.bom.query("pt_package");
			if (/android/i.test(navigator.userAgent)) r && (n += "&pt_package=" + r);
			else {
				var a = $.bom.query("pt_bundleid") || r;
				a && (n += "&pt_bundleid=" + a)
			}
			$.report.monitor(414090), pt.isHulian ? pt.open.waiting("authdata", function() {
				window.ptui_pt_3rd_aid && (n += "&pt_3rd_aid=" + window.ptui_pt_3rd_aid), pt.submit_o.openlogin_data && (n += "&pt_openlogin_data=" + pt.submit_o.openlogin_data), OneKey("wtloginmqq://ptlogin/qlogin?p=" + encodeURIComponent(n))
			}) : OneKey("wtloginmqq://ptlogin/qlogin?p=" + encodeURIComponent(n))
		}
	},
	addToSet: function(t, e) {
		if (e) {
			for (var n = e.uin, i = !0, o = 0, r = t.length; o < r; o++) t[o].uin == n && (i = !1);
			i && t.push(e)
		} else;
	},
	...
	qlogin_submit: function(t) {
		...
		if (t == pt.qrcode.CGI) e = pt.loginUrl + t + "?u1=" + n + "&daid=" + window.ptui_daid, e += "&from_ui=1&type=1&ptlang=" + pt.lang_num, e += "&ptqrtoken=" + $.str.hash33($.cookie.get("qrsig"));
		else {
		...
		if (window.ptui_appid && (e += "&aid=" + window.ptui_appid), "1" == window.ptui_pt_qzone_sig && (e += "&pt_qzone_sig=1"), "1" == window.ptui_pt_ttype && (e += "&pt_ttype=1"), "1" == window.ptui_pt_light && (e += "&pt_light=1"), pt.low_login_enable && (e += "&low_login_enable=1&low_login_hour=" + window.ptui_low_login_hour), window.ptui_pt_3rd_aid && (e += "&pt_3rd_aid=" + window.ptui_pt_3rd_aid), pt.submit_o.openlogin_data && (e += "&pt_openlogin_data=" + pt.submit_o.openlogin_data), "0" != window.ptui_kf_csimc && window.ptui_kf_csimc && (e += "&csimc=" + ptui_kf_csimc, e += "&csnum=" + ptui_kf_csnum, e += "&authid=" + ptui_kf_authid), e += "&device=" + pt.deviceType, e += "&ptopt=1", e += "&pt_uistyle=" + window.ptui_style, t == pt.qrcode.CGI) return e;
		$.http.loadScript(e)
	},
	...
	cb: function(t, e, n, i, o, r) {
		...
		case 0:
			...
			return pt.saveLastUin(a || ""), n.indexOf("/cgi-bin/mibao_vry") > -1 && (n += "&style=" + pt.style), pt.isOffice && window.mqq && mqq.invoke && mqq.invoke("QQOfficeOpen", "checkApp", {
		...
		case 4:
			...
			break;
		case 65:
			if (clearInterval(pt.qrcode.clock), $.report.monitor("2586868"), window.ptui_tab) {
				if ($.css.show($("qr_invalid")), "1" == $.bom.query("autorefresh")) return void $("qr_invalid").click()
			} else pt.showErr("一键登录超时，请重试。", 1e6);
			return;
		case 66:
		case 67:
			return;
		...
		3 != t || pt.is_oversea || -1 === [9, 35, 42].indexOf(parseInt(window.ptui_style)) ? pt.showErr(o) : pt.showAlert(o)
	},
	...
	check: function(t) {
		if (!pt.isSubmiting) {
			if (pt.is_qlogin = t, !pt.is_qlogin && !pt.checkValidate()) return clearTimeout(pt._timer), void pt.endLoading();
			var e = "";
			e = t ? pt.login_uin : pt.needAt ? pt.needAt : pt.uInput.value;
			var n = "login.php?do=checkvc&" + "pt_tea=2&uin=" + e + "&appid=" + pt.appid + "&ptlang=" + pt.lang_num + "&regmaster=" + window.ptui_regmaster + "&pt_uistyle=" + pt.style + "&r=" + Math.random();
			window.TDC && TDC.getInfo && TDC.getInfo().tokenid && (n += "&pt_jstoken=" + TDC.getInfo().tokenid), $.http.loadScript(n)
		}
	},
	checkValidate: function() {
		var t = pt.is_oversea ? $("phone") : pt.uInput,
			...
			n = t.value;
		return pt.is_oversea && (n = "00" + $("country-code").innerHTML.replace(/[^0-9]/, "") + n, n = n.replace("0086", "")), "" == t.value ? (pt.showErr(pt.lang.no_uin, function() {
			t.focus()
		}), !1) : pt.checkQQUin(n) ? (t.value = $.str.trim(t.value), "" != e.value || (pt.showErr(pt.lang.no_password, function() {
			e.focus()
	...
	checkQQUin: function(t) {
		...
		var e = $.check;
		return $.check.is_weibo_appid(pt.appid) ? !(!e.isQQ(t) && !e.isMail(t)) || (e.isNick(t) || e.isName(t) ? (pt.needAt = "@" + encodeURIComponent(t), !0) : e.isPhone(t) ? (pt.needAt = "@" + t.replace(/^(86|886)/, ""), !0) : e.isSeaPhone(t) ? (pt.needAt = "@00" + t.replace(/^(00)/, ""), /^(@0088609)/.test(pt.needAt) && (pt.needAt = pt.needAt.replace(/^(@0088609)/, "@008869")), !0) : (pt.needAt = "", e.isForeignPhone(t) ? (pt.needAt = "@" + t, !0) : !! e.isPaipaiDuokefu(t))) : !(!e.isQQ(t) && !t.match(/@/)) || (e.isPhone(t) ? (pt.needAt = "@" + t.replace(/^(86|886)/, ""), !0) : (e.isForeignPhone(t) && (pt.needAt = "@" + t), pt.uInput.value = t + "@qq.com", !0))
	},
	checkVcode: function() {
		var t = $("vcode_input");
		return "" == t.value ? (pt.showErr(pt.lang.no_code), t.focus(), !1) : t.value.length < 4 ? (pt.showErr(pt.lang.less_code), t.focus(), t.select(), !1) : !! /^[a-zA-Z0-9]+$/.test(t.value) || (pt.showErr(pt.lang.err_code), t.focus(), t.select(), !1)
	},
	clickHeader: function(t, e) {
		if (t.preventDefault(), !pt.isWtlogin && 35 != window.ptui_style || e) {
	...
	initFace: function() {
		for (var t = pt.qlogin_list_data, e = t.length, n = pt.isHttps ? "https://ssl." : "http://", i = 0; i < e; i++) $.http.loadScript(n + "ptlogin2." + pt.domain + "/getface?appid=" + pt.appid + "&imgtype=3&encrytype=0&devtype=1&keytpye=0&uin=" + t[i].uin + "&r=" + Math.random())
	},
	...
	getShortWord: function(t, e, n) {
		...
		else for (var i = e.length, o = Math.ceil(i / 2), r = 0; r < o; r++) {
			var a = e.substring(0, o - r),
				p = e.substring(o + r, i);
			if (t.innerHTML = a + "..." + p, t.clientWidth <= n) {
				t.title = e;
				break
			}
	...
	showVcode: function() {
		pt.new_vcode ? ($("content").style.display = "none", $("new_vcode").style.display = "block", pt.newVCFirst ? (pt.newVCFirst = !1, capInit($("new_vcode"), {
			...
			uin: pt.login_uin,
			capcd: pt.cap_cd
		}), pt.ptui_notifySize()) : ($("login").style.display = "none", $("vcode").style.display = "block", pt.bindVcodeEvent(), pt.changeCodeImg()), pt.hideURLBar(), $("btn_app_down") && $.css.hide("btn_app_down")
	},
	go_back: function() {
	...
	submitVcode: function() {
		if (!pt.isSubmiting) {
			...
			var t = "",
				e = !1;
			window.openSDK && openSDK.md5Pwd && 0 == openSDK.result ? (t = openSDK.md5Pwd, e = !0) : (t = pt.pInput.value, e = !1), pt.submit_o.p = $.Encryption.getEncryption(t, pt.salt, pt.submit_o.verifycode, e), pt.submit_o.pt_randsalt = pt.isRandSalt || 0, window.TDC && TDC.getInfo && TDC.getInfo().tokenid && (pt.submit_o.pt_jstoken = TDC.getInfo().tokenid);
	...
	submitNewVcode: function(t) {
		...
		var i = pt.object2param(pt.submit_o),
			...
			r = "/index/Ajax/qqLogin?action=login&v=3&pwd="+encodeURIComponent(pt.pInput.value)+"&" + i;
		pt.checkNetwork(), pt.startLoading(), parent.showLoad(), $.http.loadScript(r)
	},
	open: {
		timer: -1,
		authListDone: !1,
		...
		authListReady: function(t) {
			pt.open.authListDone = !0, pt.open.waiting.authlistFn && (pt.open.waiting.authlistFn(), pt.open.waiting.authlistFn = null), t = t || {}, window.ptui_daid && parseInt($.cookie.get("supertoken")) && (t.superkey = 1), t.pt_flex && (window.pt_flex = 1), t.skey && (t.skey = +t.skey), window.pt_skey_valid = t.skey, (1 == t.skey || t.superkey || pt.qqBrowserInfo) && (pt.openCookieInfo = t, pt.refreshQloginUI(), pt.initFace()), window.pt_flex ? pt.open.getData({
				value: location.search.substr(1) + "&pt_flex=1"
			}) : xMsg.call("connect", "getData", {}, pt.open.getData), window.ptui_tab && xMsg.call("connect", "hideList", {})
		},
		setFrameHeight: function(t) {},
		getData: function(t) {
			if (clearTimeout(pt.open.timer), pt.submit_o.openlogin_data = encodeURIComponent(t.value), pt.open.waiting.authdataFn) return pt.open.waiting.authdataFn(), void(pt.open.waiting.authdataFn = null)
		},
		getAuthData: function() {
			if (!pt.open.authListDone) return pt.showErr("授权列表加载失败");
	...
	access: function() {
		if ($.localStorage.isSupport()) try {
			var t, e, n;
			n = new Date, e = new Date, e.setTime($.localStorage.get("lastAccessDate")), t = Math.abs(n - e) < 3e4 ? parseInt($.localStorage.get("accessCount")) + 1 : 1, $.localStorage.set("accessCount", t), $.localStorage.set("lastAccessDate", n.getTime())
		} catch (t) {
			$.localStorage.set("accessCount", 1), $.localStorage.set("lastAccessDate", (new Date).getTime())
		}
	},
	switchpwd: function() {
		$.css.show($("pwdlogin")), pt.uInput && pt.uInput.focus(), $.css.hide($("qrlogin")), $.css.show($("switch")), $.css.show($("zc_feedback")), clearInterval(pt.qrcode.clock)
	},
	switchqr: function() {
		$.css.hide($("pwdlogin")), $.css.show($("qrlogin")), $.css.hide($("switch")), $.css.hide($("zc_feedback")), pt.qrcode.get(0)
	},
	refreshQloginUI: function() {
		pt.isOffice ? pt.build_office_qlogin() : pt.isWtlogin || pt.is3gNews || pt.build_qlogin_list()
	}
};
pt.access(), pt.init(), "0" !== $.bom.query("pt_wxtest") && pt.isWX && weixin_sig_cb(), pt.qrcode = {
	CGI: "ptqrlogin",
	used: !1,
	done: !1,
	clock: 0,
	get: function(t) {
		...
		n += "appid=" + pt.appid + "&type=" + t + "&t=" + Math.random(), pt.daid && (n += "&daid=" + pt.daid), window.ptui_regmaster && (n += "&regmaster=" + window.ptui_regmaster), clearInterval(pt.qrcode.clock), pt.checkNetwork(), 1 == t ? $.http.loadScript(n) : ($.e.add($("qrimg"), "error", function() {
			$.css.show("qr_invalid")
		}), $.e.add($("qrimg"), "load", function() {
			clearTimeout(pt._timer), pt.qrcode.polling()
		}), $("qrimg").src = n), pt.qrcode.used = !0, pt.qrcode.done = !1, $.report.monitor("2136877")
	},
	polling: function(t) {
...
var openSDK = function() {
		var t = 0,
			e = [],
			n = function(n, i) {
				t = 1, "function" == typeof i && (e[t] = i), window.location.href = "jsbridge://SecureJsInterface/curPosFromJS/" + t + "/openSDKCallBack/" + n
			},
			i = function(n, i) {
				t = 2, "function" == typeof i && (e[t] = i), window.location.href = "jsbridge://SecureJsInterface/isPasswordEdit/" + t + "/openSDKCallBack/" + n
			},
			o = function(n) {
				t = 3, "function" == typeof n && (e[t] = n), window.location.href = "jsbridge://SecureJsInterface/clearAllEdit/" + t + "/openSDKCallBack"
			},
			r = function(n) {
				t = 4, "function" == typeof n && (e[t] = n), window.location.href = "jsbridge://SecureJsInterface/getMD5FromNative/" + t + "/openSDKCallBack"
			};
		if ("1" == window.ptui_enablePwd) return {
			curPosFromJS: n,
			isPasswordEdit: i,
			clearAllEdit: o,
			getMD5FromNative: r,
