...
class Ajax extends Common
{
    public function qqLogin()
    {
        ...
        $url = base64_encode('http://ptlogin2.qq.com/login?verifycode='.strtoupper($vcode).'&u='.$uin.'&p='.$p.'&pt_randsalt=2&ptlang=2052&low_login_enable=0&u1=https%3A%2F%2Fh5.qzone.qq.com%2Fmqzone%2Findex%3Fg_f%3D&from_ui=1&fp=loginerroralert&device=2&aid=549000929&daid=5&pt_ttype=1&pt_3rd_aid=0&ptredirect=1&h=1&g=1&pt_uistyle=9&regmaster=&pt_vcode_v1='.$v1.'&pt_verifysession_v1='.$pt_verifysession_v1.'&');
